...
L:RegisterTranslations("enUS", function () return {
	...
	["An addon to get information about bonus from equipped items"] = "An addon to get information about bonus from equipped items",
	["show"] = "show",
	["Show all bonuses from the current equipment"] = "Show all bonuses from the current equipment",
	["Current equipment bonuses:"] = "Current equipment bonuses:",
	["details"] = "details",
	["Shows bonuses with slot distribution"] = "Shows bonuses with slot distribution",
	["Current equipment bonus details:"] = "Current equipment bonus details:",
	["item"] = "item",
	["show bonuses of given itemlink"] = "show bonuses of given itemlink",
	["<itemlink>"] = "<itemlink>",
	["Bonuses for %s:"] = "Bonuses for %s:",
	["Item is part of set [%s]"] = "Item is part of set [%s]",
	[" %sBonus for %d pieces :"] = " %sBonus for %d pieces :",
	["slot"] = "slot",
	["show bonuses of given slot"] = "show bonuses of given slot",
	["<slotname>"] = "<slotname>",
	["Bonuses of slot %s:"] = "Bonuses of slot %s:",
